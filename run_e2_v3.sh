...
vagrant ssh vm1 -c "cd /vagrant_shared/experimento2 && bash ./scripts/servidor_v3.sh" &
sleep 3

echo "Ejecutando cliente en vm2..."
vagrant ssh vm2 -c "cd /vagrant_shared/experimento2 && bash ./scripts/cliente_v3.sh"
